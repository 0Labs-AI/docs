...
<Tabs>
  ...
  <Tab title="Manual (gcloud)">
    ...
    gcloud iam roles create zeroLabsDetectionsScanner \
      --project="$PROJECT" \
      --title="0Labs Detections Read-Only Scanner" \
    ...
    gcloud iam service-accounts create zerolabs-scanner \
      --project="$PROJECT" \
      --display-name="0Labs Detections scanner (read-only)"
    ...
    gcloud projects add-iam-policy-binding "$PROJECT" \
      ...
      --role="projects/$PROJECT/roles/zeroLabsDetectionsScanner"
